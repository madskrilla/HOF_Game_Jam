...
namespace ConsoleApplication1.Track_Elements
{
    class Track : Entity
    {
        ...
        public Track() : base()
        {
            ...
            thePieces.Add(new Track_Piece(this, TrackType.sharpTurn4, Direction.Down, Direction.Right, 2, 3));
            thePieces.Add(new Track_Piece(this, TrackType.straight4, Direction.Left, Direction.Left, 1, 3));
            thePieces.Add(new Track_Piece(this, TrackType.sharpTurn4, Direction.Left, Direction.Right, 0, 3));
        }
